...
import { PageImpressum, PageDatenschutz } from "./pages/PageLegal";
      ...
      <div className="ub-shell">
        ...
        <div className="ub-main">
          <Routes>
            ...
            <Route path="/impressum"     element={<PageImpressum   lang={lang} />} />
            <Route path="/legal-notice"  element={<PageImpressum   lang={lang} />} />
            <Route path="/datenschutz"   element={<PageDatenschutz lang={lang} />} />
            <Route path="/privacy"       element={<PageDatenschutz lang={lang} />} />
        ...
        <div className="ub-footer">
          ...
          <div style={{ display:"flex", gap:18, flexWrap:"wrap" }}>
            <NavLink to={lang==="de" ? "/impressum" : "/legal-notice"} className="ub-footer-link">
              {lang==="de" ? "Impressum" : "Legal notice"}
            </NavLink>
            <NavLink to={lang==="de" ? "/datenschutz" : "/privacy"} className="ub-footer-link">
